...
func newBook(db *gorm.DB, opts ...gen.DOOption) book {
	...
	_book.CreateAt = field.NewTime(tableName, "create_at")
	_book.UpdateAt = field.NewTime(tableName, "update_at")
...
type IBookDo interface {
	...
	GetByID(id int64) (result model.Book, err error)
	GetByIDReturnMap(id int64) (result map[string]interface{}, err error)
	GetBooksByAuthor(author string) (result []*model.Book, err error)
	FilterWithColumn(column string, value string) (result []*model.Book, err error)
	Search(book *model.Book) (result []*model.Book, err error)
	SearchCustom(book *model.Book) (result []*model.Book, err error)
}

// Select * from @@table where id=@id
func (b bookDo) GetByID(id int64) (result model.Book, err error) {
...
// Select * from @@table where id=@id
func (b bookDo) GetByIDReturnMap(id int64) (result map[string]interface{}, err error) {
	var params []interface{}
...
func (b bookDo) FilterWithColumn(column string, value string) (result []*model.Book, err error) {
	var params []interface{}
...
//
// {{end}}
func (b bookDo) SearchCustom(book *model.Book) (result []*model.Book, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT * FROM book WHERE publish_date IS NOT NULL ")
	if book.Author == "" {
		params = append(params, book.CreateAt)
		generateSQL.WriteString("AND create_at <= ? ")
	}
